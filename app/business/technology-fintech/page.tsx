// app/business/technology-fintech/page.tsx
"use client"
...
export default function TechnologyFintechPage() {
  ...
  const loadArticles = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('articles')
        .select('*')
        .eq('category', 'Technology & Fintech')
        .eq('status', 'published')
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            Back to Technology & Fintech News
          </button>
              ...
              <div className="prose prose-lg max-w-none">
                {selectedArticle.content ? (
                  ...
                  <div className="text-gray-600 leading-relaxed">
                    <p className="mb-4">
                      This article provides comprehensive coverage of the latest developments in technology and 
                      fintech across {selectedArticle.country}, bringing you the most current insights and 
                      innovations from the digital finance and technology sectors.
                    </p>
                    <p className="mb-4">
                      Our team of experienced tech journalists and fintech experts work tirelessly to ensure you stay 
                      informed about digital innovations, blockchain developments, mobile money solutions, and startup ecosystem growth.
                    </p>
                    <p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight
            ...
            Technology & Fintech News
          </h1>
          <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-6">
            Discover the latest in African technology innovation, fintech developments, digital banking, 
            blockchain adoption, and startup ecosystem growth across the continent.
          </p>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                Tech & Fintech News Coming Soon
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                We&apos;re working on bringing you comprehensive technology and fintech news coverage from across Africa. 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Digital banking, mobile money, payment solutions, and financial inclusion technologies
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Funding rounds, unicorn companies, accelerator programs, and emerging tech hubs
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Cryptocurrency adoption, blockchain applications, and digital asset regulations
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Government digital initiatives, data protection laws, and technology regulations
                  </p>
                </div>
              </div>
        ...
        {!loading && articles.length === 0 && (
          <div className="mt-16 bg-gradient-to-r from-[#0F4007] to-[#1a6b0f] rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-green-100 text-lg mb-8 max-w-2xl mx-auto">
              Be the first to know when we launch our technology and fintech news section. 
              Get insights on African innovation, digital transformation, and fintech breakthroughs.
            </p>

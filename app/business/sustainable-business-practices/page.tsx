// app/business/sustainable-business-practices/page.tsx
"use client"
...
import { Calendar, ArrowLeft, Clock, Leaf } from 'lucide-react'
...
export default function SustainableBusinessPracticesPage() {
  ...
  const loadArticles = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('articles')
        .select('*')
        .eq('category', 'Sustainable Business Practices')
        .eq('status', 'published')
              ...
              <div className="prose prose-lg max-w-none">
                {selectedArticle.content ? (
                  ...
                  <div className="text-gray-600 leading-relaxed">
                    <p className="mb-4">
                      This article explores sustainable business practices and environmental responsibility 
                      initiatives across {selectedArticle.country}, highlighting innovative approaches to 
                      balancing profitability with environmental stewardship.
                    </p>
                    <p className="mb-4">
                      Our coverage focuses on companies and organizations leading the way in sustainable 
                      development, green technologies, and responsible business practices that contribute 
                      to Africa&apos;s environmental and economic sustainability.
                    </p>
                    <p>
                      Stay tuned for more comprehensive analysis and best practices in sustainable business development.
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                Sustainable Business News Coming Soon
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                We&apos;re preparing comprehensive coverage of sustainable business practices across Africa. 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Renewable energy solutions, clean tech innovations, and environmental technologies
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    ESG initiatives, social impact programs, and ethical business practices
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Waste reduction strategies, recycling innovations, and sustainable supply chains
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Green bonds, sustainable investments, and impact funding opportunities
                  </p>
                </div>
              </div>

// app/business/infrastructure-logistics/page.tsx
"use client"
...
export default function InfrastructureLogisticsPage() {
  ...
  const loadArticles = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('articles')
        .select('*')
        .eq('category', 'Infrastructure & Logistics')
        .eq('status', 'published')
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            Back to Infrastructure & Logistics News
          </button>
              ...
              <div className="prose prose-lg max-w-none">
                {selectedArticle.content ? (
                  ...
                  <div className="text-gray-600 leading-relaxed">
                    <p className="mb-4">
                      This article provides comprehensive coverage of the latest developments in infrastructure and 
                      logistics across {selectedArticle.country}, bringing you the most current insights and 
                      innovations from the infrastructure and transportation sector.
                    </p>
                    <p className="mb-4">
                      Our team of experienced infrastructure and logistics journalists work tirelessly to ensure you stay 
                      informed about major projects, transportation networks, supply chain developments, and policy changes 
                      shaping African infrastructure.
                    </p>
                    <p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight
            ...
            Infrastructure & Logistics News
          </h1>
          <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-6">
            Stay updated with the latest developments in African infrastructure, logistics networks, 
            transportation projects, and supply chain innovations across the continent.
          </p>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12">
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                Infrastructure & Logistics News Coming Soon
              </h2>
              
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                We&apos;re working on bringing you comprehensive infrastructure and logistics news coverage from across Africa. 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Rail, road, maritime, and aviation infrastructure developments across Africa
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Major infrastructure projects, construction updates, and project financing news
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    Warehouse development, distribution networks, and logistics technology innovations
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
                  ...
                  <p className="text-gray-600 text-sm">
                    IoT integration, smart cities, digital infrastructure, and tech-enabled solutions
                  </p>
                </div>
              </div>
        ...
        {!loading && articles.length === 0 && (
          <div className="mt-16 bg-gradient-to-r from-[#0F4007] to-[#1a6b0f] rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-green-100 text-lg mb-8 max-w-2xl mx-auto">
              Be the first to know when we launch our infrastructure and logistics news section. 
              Sign up for updates and never miss important developments in African infrastructure.
            </p>

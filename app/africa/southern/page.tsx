...
const SOUTHERN_AFRICA_COUNTRIES = [
  ...
  'Malawi', 'Mozambique', 'Lesotho', 'Eswatini', 'Angola'
]
  ...
  const loadArticles = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('articles')
        .select('*')
        .eq('category', 'Southern Africa')
        .eq('status', 'published')
        .in('country', SOUTHERN_AFRICA_COUNTRIES)
                ...
                {selectedArticle.content ? (
                  ...
                  <div className="text-gray-600 leading-relaxed">
                    <p className="mb-4">
                      ...
                      bringing you the most current news and insights from Southern Africa.
                    </p>
                    <p className="mb-4">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                We&apos;re working on bringing you comprehensive news coverage from Southern Africa
              </p>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-500 max-w-4xl mx-auto">
                {SOUTHERN_AFRICA_COUNTRIES.map((country, index) => (

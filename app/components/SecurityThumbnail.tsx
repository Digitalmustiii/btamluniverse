...
export default function SecurityThumbnail() {
  return (
      ...
      <div className="relative z-10 text-white py-8 lg:py-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl lg:text-2xl text-green-100 max-w-4xl mx-auto leading-relaxed">
            Stay informed with the latest security advisories, best practices, and critical updates to protect your investments and business operations across Africa.
          </p>
        </div>
          ...
          <div className="group block">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-300 group-hover:shadow-2xl border border-green-100">
              ...
              <div className="relative h-64 sm:h-80 lg:h-96 overflow-hidden">
                <Image
                  src="/images/security_updates.jpg"
                  alt="Security and protection concept"
                  fill
                ...
                {/* Floating Badge */}
                <div className="absolute top-6 left-6 bg-red-600/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                  ...
                  <div>
                    ...
                    <div className="space-y-4 text-gray-600 text-base sm:text-lg leading-relaxed">
                      ...
                      <p>
                        Our security updates provide actionable insights to help you make informed decisions and protect your assets in an evolving threat landscape.
                      </p>
                    </div>
                    ...
                    <div className="mt-8 grid sm:grid-cols-2 gap-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 font-medium">Security Advisories</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-red-600 rounded-full"></div>
                        <span className="text-gray-700 font-medium">Threat Intelligence</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-red-600 rounded-full"></div>
                        <span className="text-gray-700 font-medium">Risk Mitigation</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-red-600 rounded-full"></div>
                  ...
                  <div className="text-center lg:text-left">
                    <div className="bg-gradient-to-br from-red-50 to-orange-100 p-8 rounded-2xl border border-red-200">
                      <div className="text-6xl mb-4">🔒</div>
                      <h4 className="text-xl font-bold text-red-800 mb-4">
                        Stay Protected & Informed
                      </h4>
                      <p className="text-gray-600 mb-6">
                        Get real-time security updates and expert analysis to safeguard your business operations.
                      </p>
                      
                      {/* CTA Button */}
                      <Link
                        href="/security"
                        className="group/btn inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-700 to-red-600 text-white text-lg font-semibold rounded-xl shadow-lg transition-all duration-300 hover:from-red-600 hover:to-red-500 hover:shadow-xl hover:scale-[1.02]"
                      >
                      ...
                      <p className="text-xs text-gray-500 mt-4">
                        Updated daily with latest developments
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <div className="text-green-100">Monitoring Coverage</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <div className="text-green-100">Alert Response Time</div>
            </div>
          </div>
        </div>
